# -*- coding: utf-8 -*-
#
# TARGET arch is: ['-target', 'x86_64', '', '-I/usr/lib/gcc/x86_64-linux-gnu/9/include', '-I/usr/local/include', '-I/usr/include/x86_64-linux-gnu', '-I/usr/include', '-I/home/peter/code/parrot-groundsdk/out/olympe-linux/build/libulog', '-I/home/peter/code/parrot-groundsdk/packages/common/ulog/libulog', '-I/home/peter/code/parrot-groundsdk/packages/common/ulog/libulog/include', '-I/home/peter/code/parrot-groundsdk/out/olympe-linux/staging/usr/include/x86_64-linux-gnu', '-I/home/peter/code/parrot-groundsdk/out/olympe-linux/staging/usr/include', '-std=gnu99', '-pipe', '-O2', '-g', '-ffunction-sections', '-DALCHEMY_BUILD', '-m64', '-fPIC', '-msse', '-msse2', '-mssse3', '-fvisibility=hidden', '-D__PYBINDING_MACRO__=1', '-fno-unsigned-char', '']
# WORD_SIZE is: 8
# POINTER_SIZE is: 8
...
__all__ = \
    ['__ulog_default_cookie', 'struct___va_list_tag',
    ...
    'ulog_raw_close', 'ulog_raw_log', 'ulog_raw_open',
    'ulog_set_cookie_register_func', 'ulog_set_level',
    'ulog_set_tag_level', 'ulog_set_write_func', 'ulog_vlog_write',
    'ulog_write_func_t', 'va_list']
